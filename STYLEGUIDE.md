...
- HTML 文書や HTTP メッセージの一部だけを示す場合は、省略した例であることと、省略した範囲を本文で明示する。文書全体を説明する場面では、`doctype`、`html`、`head`、`body` を含む形を示す。
...
- 入力チェックに失敗してフォームを再表示するレスポンスには `422 Unprocessable Content` を使う。画面を再表示できたことと、登録や更新に成功したことを区別して説明する。
